...
bool CRageBot::Run()
{
	...
	G::UserCmd->viewangles.ClampAngles();
...
void CRageBot::GoToTarget()
{
	...
	{
		if (Settings::Ragebot::AutoScope && (G::LocalPlayer->GetWeapon()->GetWeaponType() == WEAPONTYPE_SNIPER_RIFLE || G::LocalPlayer->GetWeapon()->GetWeaponId() == WEAPON_AUG || G::LocalPlayer->GetWeapon()->GetWeaponId() == WEAPON_SG553) && !G::LocalPlayer->GetIsScoped())
		{
