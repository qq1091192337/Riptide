	...
	void OnRender()
	{
		...
		if (g_pRender && Interfaces::Engine()->IsActiveApp())
		{
			...
			if (Settings::Esp::esp_Watermark)
			{
				...
				if (u > 300 && u <= 400)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "");
				if (u > 400 && u <= 500)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "Riptide Remastered");
				if (u > 500 && u <= 600)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "Riptide Remastered");
				if (u > 600 && u <= 700)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "Riptide Remastered");
				if (u > 700 && u <= 800)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "");
				if (u > 800 && u <= 900)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "Riptide Remastered");
				if (u > 900 && u <= 1000)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "Riptide Remastered");
				if (u > 1000 && u <= 1100)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "Riptide Remastered");
				if (u > 1100 && u <= 1200)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "");
				if (u > 1200 && u <= 1300)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "Riptide Remastered");
				if (u > 1300 && u <= 1400)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "Riptide Remastered");
				if (u > 1400 && u <= 1500)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "Riptide Remastered");
				if (u > 1500 && u <= 1600)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "");
				if (u > 1600 && u <= 1700)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "by Baseult");
				if (u > 1700 && u <= 1800)    g_pRender->Text(15, 15, false, true, Color::FromHSB(rainbow, 1.f, 1.f), "");
...
//---------------------------------------------------------------------------------Ragebot--------------------------------------------------------------------------------------------
			if (tabSelected == 0) // Rage
			{
				...
				ImGui::BeginChild(1, ImVec2(-1, 680), true);
				{
					...
					{
						ImGui::Separator();
						ImGui::Text("!ENABLE MULTI POINT AND DISABLE AUTOWALL FOR HITBOX OR IT WONT WORK!");
						...
						if (ImGui::IsItemHovered())
							ImGui::SetTooltip("BUGGY - Auto Scopes when able to shoot at Target");
						...
						if (ImGui::IsItemHovered())
							ImGui::SetTooltip("Shoots ONLY at selected Hitpoint - Use (Hit Scan = Custom) for Multiple Hitpoints");
						...
						if (ImGui::IsItemHovered())
							ImGui::SetTooltip("Only shoots if Chance is x to hit the enemy - !High % = maybe won't shoot!");
...
//------------------------------------------------------------------------Aimbot-----------------------------------------------------------------------------------------------------
			...
			ImGui::BeginChild(1, ImVec2(-1, 680), true);
			{
				...
				if (otherpages == 1)
				{
					...
					ImGui::Spacing();
					ImGui::Text("!PSILENT IS OBVIOUS IN OVERWATCH! - Silent Aimbot Shoots at Targets without Aiming at them");
					...
					if (ImGui::IsItemHovered())
						ImGui::SetTooltip("Sets FOV for Silent Aimbot");
					...
					ImGui::Text("Smoothing: Enable Smoothing and RCS Smooth or it won't work");
